...
document.addEventListener('DOMContentLoaded', () => {
    ...
    formulario.addEventListener('submit', submirtFormulario);
...
function mostrarCotizacionHTML(cotizacion) {
    ...
    ultimaActualizacion.innerHTML = `<p>Ultima Actualizacion 24 horas <span>${LASTUPDATE}</span></p>`
